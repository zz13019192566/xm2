				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  <li class="layui-nav-item layui-nav-itemed">
				    ...
				    <dl class="layui-nav-child">
				      <dd><a href="javascript:; " data-url="/admin/user" data-id='1' data-text="浏览管理员"><span class="l-line"></span>浏览管理员</a></dd>
				      <dd><a href="javascript:;" data-url="/admin/user/create" data-id='2' data-text="添加管理员"><span class="l-line"></span>添加管理员</a></dd>
				    </dl>
				  </li>
				  <li class="layui-nav-item layui-nav-itemed">
